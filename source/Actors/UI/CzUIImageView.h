...
#if !defined(_CCZ_UI_IMAGE_VIEW_H_)
#define _CCZ_UI_IMAGE_VIEW_H_
...
//
//
// CzUIImageView - UI class that allows the user to navugate a large image
//
//
//
//
class CzUIImageView : public CzUIBase
{
public:
	// Properties
protected:
	CzUIIcon*			Icon;							///< The ico0n that is used to display the image
	CzIVec2				Area;							///< The area that the image should fit into
	float				Zoom;							///< Current zoom
	float				MinZoom;						///< The minimum zoom point
	float				MaxZoom;						///< The maximum zoom point
public:
	CzUIIcon*			getIcon()						{ return Icon; }
...
protected:
	static CzXomlClassDef*	ImageViewClassDef;								// XOML class definition
public:
...
//
//  CzUIImageViewCreator - Creates an instance of a ImageView actor object
//
class CzUIImageViewCreator : public IzXomlClassCreator
{
public:
	...
	IzXomlResource*	CreateInstance(IzXomlResource* parent)	{ return new CzUIImageView(); }
};

#endif	// _CCZ_UI_IMAGE_VIEW_H_
